...
<body>
    ...
    <asp:TextBox ID="textUsername" runat="server"  placeholder="Username" Width="120px" CssClass="auto-style3"></asp:TextBox>
        ...
        <asp:Label ID="Label1" runat="server" Font-Names="Arial Black" Font-Size="X-Large" Text="REGISTRATION SUCCESSFUL!"></asp:Label>

        <br />
        <br />
        <asp:Label ID="Label2" runat="server" Font-Names="Arial" Font-Size="Medium" Text="You can now use your newly created account to log in."></asp:Label>
